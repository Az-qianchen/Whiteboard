...
const LanguageSelector: React.FC = () => {
  ...
  return (
    <Popover className="relative w-full">
      ...
      >
        <Popover.Panel className="absolute inset-x-0 mt-2 max-h-48 overflow-y-auto bg-[var(--ui-popover-bg)] backdrop-blur-lg rounded-xl shadow-lg border border-[var(--ui-panel-border)] z-30 p-1">
          {({ close }) => (
