    ...
    return (
        <div className="flex flex-col items-center w-14" title="效果">
            <Popover className="relative">
                <Popover.Button className={`p-2 ${BUTTON_SIZE_SM} rounded-lg flex items-center justify-center transition-colors text-[var(--text-secondary)] hover:bg-[var(--ui-hover-bg)] ring-1 ring-inset ring-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]`} title="效果">
                    {ICONS.EFFECTS}
                </Popover.Button>
