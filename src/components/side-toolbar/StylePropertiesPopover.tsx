    ...
    return (
        <div className="flex flex-col items-center w-14" title="样式属性">
            <Popover className="relative">
                <Popover.Button className="p-2 h-11 w-11 rounded-lg flex items-center justify-center transition-colors text-[var(--text-secondary)] hover:bg-[var(--ui-hover-bg)] ring-1 ring-inset ring-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]" title="样式属性">
                    {ICONS.PROPERTIES}
                </Popover.Button>
