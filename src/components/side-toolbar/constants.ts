...
export const FILL_STYLE_ICONS = {
  solid: React.createElement(
    'svg',
    { width: FILL_ICON_SIZE, height: FILL_ICON_SIZE, viewBox: '0 0 20 20', className: ICON_SIZE, fill: 'currentColor' },
    React.createElement('rect', { x: '2', y: '2', width: '16', height: '16' })
  ),
  hachure: React.createElement(
    'svg',
    { width: FILL_ICON_SIZE, height: FILL_ICON_SIZE, viewBox: '0 0 20 20', className: ICON_SIZE, fill: 'none', stroke: 'currentColor', strokeWidth: '1.5' },
  ...
  'cross-hatch': React.createElement(
    'svg',
    { width: FILL_ICON_SIZE, height: FILL_ICON_SIZE, viewBox: '0 0 20 20', className: ICON_SIZE, fill: 'none', stroke: 'currentColor', strokeWidth: '1.5' },
  ...
  dashed: React.createElement(
    'svg',
    { width: FILL_ICON_SIZE, height: FILL_ICON_SIZE, viewBox: '0 0 20 20', className: ICON_SIZE, fill: 'none', stroke: 'currentColor', strokeWidth: '1.5' },
    React.createElement('path', { d: 'M 4 5 H 8 M 12 5 H 16 M 4 10 H 8 M 12 10 H 16 M 4 15 H 8 M 12 15 H 16' }),
    React.createElement('rect', { x: '2', y: '2', width: '16', height: '16', fill: 'none', stroke: 'currentColor', strokeWidth: '1' })
  ),
  zigzag: React.createElement(
    'svg',
    { width: FILL_ICON_SIZE, height: FILL_ICON_SIZE, viewBox: '0 0 20 20', className: ICON_SIZE, fill: 'none', stroke: 'currentColor', strokeWidth: '1' },
    React.createElement('path', { d: 'M 3 4 L 7 8 L 3 12 L 7 16 M 8 4 L 12 8 L 8 12 L 12 16 M 13 4 L 17 8 L 13 12 L 17 16' }),
    React.createElement('rect', { x: '2', y: '2', width: '16', height: '16', fill: 'none', stroke: 'currentColor', strokeWidth: '1' })
  ),
  'zigzag-line': React.createElement(
    'svg',
    { width: FILL_ICON_SIZE, height: FILL_ICON_SIZE, viewBox: '0 0 20 20', className: ICON_SIZE, fill: 'none', stroke: 'currentColor', strokeWidth: '1' },
