...
export const SideToolbarPanel: React.FC = () => {
    ...
    const { isSideToolbarCollapsed, setIsSideToolbarCollapsed, handleToggleStyleLibrary, handleAdjustImageHsv, timelineHeight } = store;
    ...
    return (
        <>
            ...
            <div 
                ...
                style={{
                    top: `calc(50% - ${timelineHeight / 2}px)`,
