    ...
    >
      ...
      >
        ...
        <g style={{ transform: `translate(${viewTransform.translateX}px, ${viewTransform.translateY}px) scale(${viewTransform.scale})` }}>
          ...
          <PathsRenderer paths={backgroundPaths} rc={rc} isBackground previewSrcById={previewSrcById} previewRequestVersion={previewRequestVersion} />
          <PathsRenderer paths={onionSkinPaths} rc={rc} previewSrcById={previewSrcById} previewRequestVersion={previewRequestVersion} />
          <PathsRenderer paths={visiblePaths} rc={rc} previewSrcById={previewSrcById} previewRequestVersion={previewRequestVersion} />
