import type { AnyPath, Point, ResizeHandlePosition, RectangleData, EllipseData, ImageData, PolygonData, TextData, FrameData, GroupData, ArcData, BrushPathData, VectorPathData } from '@/types';
