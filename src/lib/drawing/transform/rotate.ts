...
export function rotatePath<T extends AnyPath>(path: T, center: Point, angle: number): T {
  switch (path.tool) {
    ...
    case 'line': {
      ...
      return { ...path, anchors: newAnchors } as T;
    }
    case 'frame':
    case 'rectangle':
    case 'ellipse':
