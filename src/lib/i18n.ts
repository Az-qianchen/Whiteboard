...
const resources = {
  en: {
    translation: {
      ...
      cropMagicWandPolygonHint: 'Click to add points\nReturn to the first point or double-click to close',
      cropMagicWandPolygonClose: 'Release to close selection',
  ...
  zh: {
    translation: {
      ...
      cropAdjust: '裁剪',
      cropMagicWand: '抠图',
      cropMagicWandFreehand: '手绘选区',
      cropMagicWandPolygon: '直线选区',
      cropMagicWandPolygonHint: '逐点点击添加顶点\n回到起点或双击可闭合选区',
      cropMagicWandPolygonClose: '松开鼠标即可闭合选区',
      cropSelectionAdd: '添加选区',
      cropSelectionSubtract: '减少选区',
