  ...
  en: {
    translation: {
      ...
      filesPanel: {
        ...
        noFolderDescription: 'Select a folder to browse whiteboard files.',
        currentFolder: 'Current folder: {{name}}',
        selectFolder: 'Select folder…',
        changeFolder: 'Change folder…',
        refresh: 'Refresh',
        createFile: 'New file',
        hint: 'Click a file to open it in the editor.',
        emptyState: 'No editable whiteboard files were found in this folder.',
        loading: 'Loading…',
        unsupported: 'Folder access is not supported in this browser.',
        permissionDenied: 'Permission to read this folder was denied.',
        unknownError: 'Failed to read folder contents.',
        unknownErrorWithMessage: 'Failed to read folder contents: {{message}}',
        createFileFailed: 'Failed to create file.',
        createFileFailedWithMessage: 'Failed to create file: {{message}}',
        lastModified: 'Updated {{value}}',
        unknownDate: 'Unknown date',
        activeBadge: 'Current',
        confirmSwitchTitle: 'Discard unsaved changes?',
        confirmSwitchMessage: 'Opening another file will discard any unsaved changes to this board.',
        confirmSwitchConfirm: 'Discard and open',
      },
  ...
  zh: {
    translation: {
      ...
      filesPanel: {
        ...
        noFolderDescription: '选择一个文件夹以浏览可编辑的画板文件。',
        currentFolder: '当前文件夹：{{name}}',
        selectFolder: '选择文件夹…',
        changeFolder: '更换文件夹…',
        refresh: '刷新',
        createFile: '新建文件',
        hint: '点击文件即可在画板中打开。',
        emptyState: '该文件夹中没有可编辑的画板文件。',
        loading: '加载中…',
        unsupported: '当前浏览器不支持文件夹访问。',
        permissionDenied: '没有读取该文件夹的权限。',
        unknownError: '读取文件夹内容失败。',
        unknownErrorWithMessage: '读取文件夹内容失败：{{message}}',
        createFileFailed: '无法创建新文件。',
        createFileFailedWithMessage: '无法创建新文件：{{message}}',
        lastModified: '更新于 {{value}}',
        unknownDate: '未知时间',
        activeBadge: '当前',
        confirmSwitchTitle: '有未保存的更改',
        confirmSwitchMessage: '打开其他文件将放弃当前画板中未保存的更改，是否继续？',
        confirmSwitchConfirm: '放弃更改并打开',
      },
