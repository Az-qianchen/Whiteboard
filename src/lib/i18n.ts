...
const resources = {
  en: {
    translation: {
      ...
      fileManager: {
        title: 'Manage files',
        description: 'Browse imported assets stored in this whiteboard and rename them.',
        ...
        saveButton: 'Save',
        selectFile: 'Select a file to rename it.',
        unnamedFile: 'Untitled file',
        previewTitle: 'Preview',
        previewLoading: 'Loading preview…',
        previewUnavailable: 'Preview unavailable for this file type.',
        previewError: 'Could not load a preview for this file.',
        noFileSelected: 'Select a file from the list to see details.',
        metadataTitle: 'File info',
        metadataName: 'Name',
        metadataPath: 'Path',
        metadataType: 'Type',
        metadataSize: 'Size',
        metadataCreated: 'Created',
        metadataModified: 'Last modified',
        downloadButton: 'Download',
        renameSuccess: 'File name updated.',
  ...
  zh: {
    translation: {
      ...
      fileManager: {
        title: '文件管理',
        description: '浏览并管理当前画板中保存的资源，可对文件进行重命名。',
        currentFolder: '当前文件夹',
        root: '根目录',
        goUp: '返回上一级',
        empty: '该文件夹暂时没有文件。',
        ...
        saveButton: '保存',
        selectFile: '选择一个文件后即可进行重命名。',
        unnamedFile: '未命名文件',
        previewTitle: '文件预览',
        previewLoading: '正在加载预览…',
        previewUnavailable: '此文件类型暂不支持预览。',
        previewError: '无法加载该文件的预览。',
        noFileSelected: '请选择左侧的文件以查看详情。',
        metadataTitle: '文件信息',
        metadataName: '名称',
        metadataPath: '路径',
        metadataType: '类型',
        metadataSize: '大小',
        metadataCreated: '创建时间',
        metadataModified: '更新时间',
        downloadButton: '下载',
        renameSuccess: '文件名已更新。',
        downloadError: '无法下载该文件。',
      },
      open: '打开…',
      save: '保存',
      saveAs: '另存为…',
