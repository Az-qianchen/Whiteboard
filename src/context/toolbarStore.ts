...
import type { EndpointStyle, GradientFill, TextAlignment } from '@/types';
...
export interface ToolbarState {
  ...
  drawingTextAlign: TextAlignment;
  setDrawingTextAlign: (v: TextAlignment) => void;
...
export const useToolbarStore = create<ToolbarState>()(
  persist(
    (set) => ({
      ...
      drawingFontFamily: 'Excalifont, "Segoe UI", sans-serif',
