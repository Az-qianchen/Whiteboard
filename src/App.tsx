...
const App: React.FC = () => {
  ...
  const [backgroundColor, setBackgroundColor] = useState(() => getLocalStorageItem('whiteboard_backgroundColor', '#121215'));
  ...
  const { 
    ...
    handleAddStyle, handleApplyStyle, handleSaveLibrary, handleLoadLibrary, handleClearLibrary,
  ...
  const canClearCanvas = pathState.canClear || !!drawingInteraction.drawingShape || backgroundColor !== '#121215';
